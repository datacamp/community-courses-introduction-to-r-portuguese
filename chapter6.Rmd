...
- ***Data frames* (objetos de duas dimensões): podem 

- **Data frames** (two-dimensional objects): podem armazenar valores numeric, character e logical também. Dentro de uma coluna, todos os elementos são do mesmo tipo de dados, mas diferentes colunas podem ser de diferentes tipos.

Muito bom para um iniciante em R, certo? ;-)
